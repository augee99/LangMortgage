...
def run_mortgage_validation(application_data: dict) -> dict:
    ...
    initial_state = MortgageState(
        ...
        square_footage=application_data.get("square_footage"),
        bedrooms=application_data.get("bedrooms"),
        bathrooms=application_data.get("bathrooms"),
        year_built=application_data.get("year_built"),
        lot_size=application_data.get("lot_size"),
